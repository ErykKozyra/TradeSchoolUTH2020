...
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  const filteredBody = filterObj(
    ...
    'email',
    'number'
  ); // normalnie program kazałby wpisać wszystkie dane, łącznie z rolą (np. admin) / funkcja filtruje podane dane, aby program nie wymagał pewnych danych
...
exports.joinCourse = catchAsync(async (req, res) => {
  const filteredBody = filterObj(req.body, 'course');
...
exports.discontinue = catchAsync(async (req, res) => {
