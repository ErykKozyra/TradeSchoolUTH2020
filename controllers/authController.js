...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  try {
    await sendEmail({
      // fn wysyłająca email
      email: newUser.email, // odbiorca
      subject: 'Witaj w TradeSchool!', // temat wiadomości
      message: `Witaj ${newUser.name}!\nBardzo nam miło, że postanowiłeś do nas dołączyć.\nSkorzystaj z naszych darmowych kursów i zapisz się już teraz!`
    });
