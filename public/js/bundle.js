        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Rejestracja zakończona powodzeniem');
              location.assign('/');
            }
          ...
          case 7:
            ...
            errArr = _context.t0.response.data.message.split(',');
            ...
            (0, _alerts.showAlert)('error', "".concat(error.join('. '), "."));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logowanie zakończone sukcesem');
              location.assign('/');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('success', 'Zostałeś wylogowany');
              location.assign('/');
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Błąd podczas wylogowywania. Spróbuj ponownie');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"patch.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.discountinue = exports.updateData = void 0;
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, route) {
    var res, text;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/".concat(route),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              if (route.startsWith('users/updateMe')) text = 'Twoje dane zostały pomyślnie zmienione';else if (route.startsWith('users/updateMyPassword') || route.startsWith('users/resetPassword')) text = 'Twoje hasło zostało pomyślnie zmienione';else if (route.startsWith('courses')) text = 'Pomyślnie zaktualizonao kurs';else if (route.startsWith('users/joinCourse')) text = 'Pomyślnie zapisałeś się na kurs';else if (route.startsWith('subjects')) text = 'Pomyślnie aktualizowałeś przedmiot';
            }

            (0, _alerts.showAlert)('success', text);
            location.assign('/');
            _context.next = 12;
            break;
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Coś poszło nie tak. Spróbuj ponownie');
...
var discountinue = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Wypisano z kursu');
              location.assign('/');
            }
  ...
  return function discountinue(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.discountinue = discountinue;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            text = 'Polecenie wykonane';

            if (res.data.status === 'success') {
              if (route.startsWith('users/deleteMe')) text = 'Twoje konto zostało pomyślnie usunięte';else if (route.startsWith('courses')) text = 'Kurs został pomyślnie usunięty';
            }
...
exports.forgotPassword = exports.createData = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              if (route.startsWith('courses')) text = 'Pomyślnie dodano kurs';else if (route.startsWith('subjects')) text = 'Pomyślnie dodano przedmiot';else if (route.startsWith('forgotPassword')) text = 'Wysłano e-mail';
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Pomyślnie wysłano email');
              location.assign('/');
            }
...
var checkbox = document.getElementById('cokolwiek');
...
var delAccountBtn = document.querySelector('.btn-account-delete');
var delCourseBtn = document.querySelector('.btn-course-delete');
var updateCourseForm = document.querySelector('.update-course');
var selectTag = document.querySelector('.select-tag');
var limit = document.querySelector('.limit');
var page = document.querySelector('.page');
var join = document.getElementById('joinSlugArr');
var createCourse = document.querySelector('.create-course');
var createSubject = document.querySelector('.create-subject');
var delSubjectBtn = document.querySelector('.btn-subject-delete');
var forgotPasswordForm = document.querySelector('.forgot-password');
var newPasswordForm = document.querySelector('.new-password');
var updateSubjectForm = document.querySelector('.update-subject');
var discontinueBtn = document.querySelector('.discontinue');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(data);
  (0, _patch.updateData)(data, 'users/updateMe');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _patch.updateData)(data, 'users/updateMyPassword');
...
if (delAccountBtn) delAccountBtn.addEventListener('click', function () {
  if (confirm('Czy jesteś pewien, że chcesz usunąć swoje konto? Proces ten jest nieodwracalny. Użycie tego samego adresu email w naszym systemie będzie niemożliwe.')) {
    (0, _delete.deleteData)('users/deleteMe');
  }
});
if (selectTag) selectTag.addEventListener('change', function () {
  ...
  var search = "?".concat(usp.toString());
  var url = "".concat(window.location.origin).concat(window.location.pathname).concat(search);
...
if (page) {
  ...
  var sumUsers = document.getElementById('sumUsers').textContent * 1;
  var queryString = window.location.search;
  var usp = new URLSearchParams(queryString);
  var pageNum = usp.get('page') || 1;
  var limitNum = usp.get('limit') || 100;
  var maxRes = Math.ceil(sumUsers / limitNum);
  next.addEventListener('click', function () {
    if (pageNum < maxRes) pageNum++;
    usp.set('page', "".concat(pageNum));
    var search = "?".concat(usp.toString());
    var url = "".concat(window.location.origin).concat(window.location.pathname).concat(search);
    window.location.href = url;
  });
...
if (join) {
  var slugStr = document.getElementById('joinSlugArr').textContent;

  if (slugStr.length !== 0) {
    (function () {
      var idStr = document.getElementById('joinIdArr').textContent;
      var slugArr = slugStr.split(',');
      var idArr = idStr.split(',');
      var arrDOM = [];

      var _loop = function _loop(i) {
        arrDOM[i] = document.getElementById("".concat(slugArr[i]));
        arrDOM[i].addEventListener('click', function () {
          if (confirm('Czy jesteś pewien, że chcesz się zapisać na ten kurs? Proces ten jest nieodwracalny. Klikając TAK, zobowiązujesz się do uczestnictwa w kursie, aż do jego zakończenia!')) {
            var data = {
              course: idArr[i]
            };
            (0, _patch.updateData)(data, 'users/joinCourse');
          }
        });
      };
...
if (discontinueBtn) discontinueBtn.addEventListener('click', function () {
  var pathname = window.location.pathname;
  var id = pathname.substring(pathname.lastIndexOf('/') + 1);
  var route = "users/discontinue/".concat(id);

  if (confirm('Czy jesteś pewien, że chcesz wypisać użytkownika z kursu?')) {
    (0, _patch.discountinue)(route);
  }
});
...
if (updateCourseForm) updateCourseForm.addEventListener('submit', function (e) {
  ...
  var slugStr = document.getElementById('slugArr').textContent;
  var idStr = document.getElementById('idArr').textContent;
  var slugArr = slugStr.split(',');
  var idArr = idStr.split(',');
  var arrDOM = [];
  ...
  var pathname = window.location.pathname;
  var id = pathname.substring(pathname.lastIndexOf('/') + 1);
  var route = "courses/".concat(id);
  (0, _patch.updateData)(data, route);
});
if (delCourseBtn) delCourseBtn.addEventListener('click', function () {
  if (confirm('Czy jesteś pewien, że chcesz usunąć ten kurs? Usunięcie kursu spowoduje jednoczesne wypisanie z niech wszystkie osoby w nim uczestniczące.')) {
    var pathname = window.location.pathname;
    var id = pathname.substring(pathname.lastIndexOf('/') + 1);
    var route = "courses/".concat(id);
    (0, _delete.deleteData)(route);
  }
});
if (createCourse) createCourse.addEventListener('submit', function () {
  var data = {};
  data.name = document.getElementById('name').value;
  data.description = document.getElementById('description').value;
  (0, _post.createData)(data, 'courses');
});
if (createSubject) createSubject.addEventListener('submit', function () {
  var data = {};
  data.name = document.getElementById('name').value;
  ...
  for (var i = 0; i < idArr.length; i++) {
    arrDOM[i] = document.getElementById("".concat(idArr[i]));
    if (arrDOM[i].checked === true) data.teacher = idArr[i];
  }

  (0, _post.createData)(data, 'subjects');
});
if (delSubjectBtn) delSubjectBtn.addEventListener('click', function () {
  if (confirm('Czy jesteś pewien, że chcesz usunąć ten przedmiot? Zostanie on usunięty ze wszystkich obecnych kursów!')) {
    var pathname = window.location.pathname;
    var id = pathname.substring(pathname.lastIndexOf('/') + 1);
    var route = "subjects/".concat(id);
    (0, _delete.deleteData)(route);
  }
});
if (updateSubjectForm) updateSubjectForm.addEventListener('submit', function () {
  var data = {};
  var name = document.getElementById('name').value;
...
if (forgotPasswordForm) forgotPasswordForm.addEventListener('submit', function () {
  var data = {};
  data.email = document.getElementById('email').value;
  (0, _post.forgotPassword)(data);
});
if (newPasswordForm) newPasswordForm.addEventListener('submit', function () {
  var data = {};
  data.password = document.getElementById('password').value;
  data.passwordConfirm = document.getElementById('passwordConfirm').value;
  var pathname = window.location.pathname;
  var id = pathname.substring(pathname.lastIndexOf('/') + 1);
  var route = "users/resetPassword/".concat(id);
  (0, _patch.updateData)(data, route);
});
